...
class CurriculoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'experiencia_profissional.*.tipo' => 'required_with:experiencia_profissional|string',
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $curriculo->escolaridades()->delete();
            if ($request->has('escolaridade')) {
                foreach ($request->escolaridade as $edu) {
                    $curriculo->escolaridades()->create($edu);
                }
            ...
            return response()->json($curriculo->load(['experienciasProfissionais', 'escolaridades', 'cursos']), 200);
        } catch (\Exception $e) {
            return response()->json(['message' => $e->getMessage()], 500);
        }
    }
